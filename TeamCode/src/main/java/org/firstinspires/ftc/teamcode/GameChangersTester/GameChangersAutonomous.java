...
//                b.addDrive(S.DRIVE_1C, S.SET_VUCALC, Distance.fromFeet(.3), 1.0, 0, 0);
            ...
            b.add(S.SHOOT_RINGS, new ShooterState( robotCfg, GameChangersRobotCfg.shooterTargetSpeed, GameChangersRobotCfg.shooterMaxSpeed, S.SECOND_RING_COLLECTION));
            ...
            //0 rings
            //-------------------------------------------------------------------------------------------------------------------------------
            b.add(S.TURN_OFF_SHOOTER,makeFlyWheelStopState(S.DRIVE_RING_0));
            ...
            b.addServo(S.DROP_WOBBLE_GOAL_4, S.DRIVE_BACK, robotCfg.getPincher().getName(), ServoPresets.WobblePincher.OPENED, servoReleaseWaitTime,true);
